			...
			<MobileMenu open={open} className="flex flex-col justify-between gap-2">
				...
				<div className="flex flex-col gap-2">
					{user ? (
						...
						<>
							<Link href="/login" onClick={() => setOpen(false)} className={buttonVariants({ variant: 'outline', className: 'w-full bg-transparent' })}>
								Login
							</Link>
							<Link href="/signup" onClick={() => setOpen(false)} className={buttonVariants({ className: 'w-full' })}>
								Get Started
							</Link>
						</>
					)}
