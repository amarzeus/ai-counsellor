    ...
    if (items.length === 0) {
        return (
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-4">
                <p className="text-sm text-gray-500 text-center">No upcoming deadlines found for your locked universities.</p>
            </div>
        );
    }
                ...
                {items.map((item, index) => (
                    ...
                    >
                        ...
                        {index !== items.length - 1 && (
                            <div className="absolute left-6 top-10 bottom-0 w-0.5 bg-gray-100 group-hover:bg-gray-200 transition-colors" />
                        )}
              ...
              `}>
                            ...
                            <div className="flex-1 bg-gray-50 rounded-lg p-4 hover:bg-white hover:shadow-md transition-all border border-transparent hover:border-gray-100">
                                <div className="flex justify-between items-start">
                                    <div>
                                        <h3 className="font-semibold text-gray-900">{item.university_name}</h3>
                                        <p className="text-sm text-gray-600 mb-1">{item.program_name}</p>
                    ...
                    `}>
                                        ...
                                        <span className="text-xs text-gray-500 uppercase tracking-wider font-semibold">Days Left</span>
                                    </div>
                                </div>
