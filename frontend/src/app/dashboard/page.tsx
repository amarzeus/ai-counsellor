        ...
        <div className="grid lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              <div className="bg-white dark:bg-slate-900 rounded-2xl p-5 shadow-sm border border-slate-200 dark:border-slate-800 hover:border-blue-500/30 transition-colors group">
                ...
                <p className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">{dashboard?.shortlisted_count || 0}</p>
              </div>

              <div className="bg-white dark:bg-slate-900 rounded-2xl p-5 shadow-sm border border-slate-200 dark:border-slate-800 hover:border-purple-500/30 transition-colors group">
                <div className="flex items-center gap-3 mb-2">
                ...
                <p className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">{dashboard?.locked_count || 0}</p>
              </div>

              <div className="bg-white dark:bg-slate-900 rounded-2xl p-5 shadow-sm border border-slate-200 dark:border-slate-800 hover:border-orange-500/30 transition-colors group">
                <div className="flex items-center gap-3 mb-2">
                  <div className="p-1.5 bg-orange-50 dark:bg-orange-900/20 rounded-lg group-hover:bg-orange-100 dark:group-hover:bg-orange-900/30 transition-colors">
                    <Clock className="w-4 h-4 text-orange-600 dark:text-orange-400" />
                  </div>
                  <span className="text-xs font-medium text-slate-500 dark:text-slate-400">Pending</span>
                </div>
                <p className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">{dashboard?.pending_tasks || 0}</p>
              </div>
            </div>

            {/* Profile Strength */}
            <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-slate-200 dark:border-slate-800">
              <h3 className="text-lg font-semibold mb-4 text-slate-900 dark:text-white tracking-tight">Profile Strength</h3>
              <div className="grid sm:grid-cols-3 gap-4">
                <div className="text-center p-4 bg-slate-50 dark:bg-slate-950/50 rounded-xl border border-slate-100 dark:border-slate-800/50">
                  <GraduationCap className="w-6 h-6 mx-auto mb-2 text-blue-600 dark:text-blue-400" />
                  <p className="text-xs font-medium text-slate-500 dark:text-slate-400 mb-1">Academics</p>
                  <p className={`text-base font-bold ${dashboard?.profile_strength?.academics === "Strong"
                ...
                <div className="text-center p-4 bg-slate-50 dark:bg-slate-950/50 rounded-xl border border-slate-100 dark:border-slate-800/50">
                  ...
                  <p className="text-xs font-medium text-slate-500 dark:text-slate-400 mb-1">Exams</p>
                  <p className={`text-base font-bold ${dashboard?.profile_strength?.exams === "Completed"
                ...
                <div className="text-center p-4 bg-slate-50 dark:bg-slate-950/50 rounded-xl border border-slate-100 dark:border-slate-800/50">
                  <CheckCircle className="w-6 h-6 mx-auto mb-2 text-purple-600 dark:text-purple-400" />
                  <p className="text-xs font-medium text-slate-500 dark:text-slate-400 mb-1">SOP</p>
                  <p className={`text-base font-bold ${dashboard?.profile_strength?.sop === "Ready"
                    ? "text-emerald-600 dark:text-emerald-400"
            ...
            {dashboard?.current_stage === "DISCOVERY" && shortlist.length === 0 && (
              <div className="bg-blue-50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-900/30 rounded-2xl p-6 relative overflow-hidden group hover:shadow-md transition-all cursor-pointer" onClick={() => router.push('/counsellor')}>
                ...
                <div className="flex items-start gap-5 relative z-10">
                  ...
                  <div className="flex-1">
                    ...
                    <button
                      className="inline-flex items-center gap-2 px-5 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700 transition hover:shadow-lg hover:shadow-blue-600/20"
                    >
            ...
            {shortlist.length > 0 && lockedUniversities.length === 0 && (
              <div className="bg-amber-50 dark:bg-amber-900/10 border border-amber-100 dark:border-amber-900/30 rounded-2xl p-6 relative overflow-hidden hover:shadow-md transition-all cursor-pointer" onClick={() => router.push('/universities')}>
                <div className="flex items-start gap-5">
                  ...
                  <div className="flex-1">
                    ...
                    <button
                      className="inline-flex items-center gap-2 px-5 py-2 bg-amber-600 text-white rounded-lg text-sm font-medium hover:bg-amber-700 transition hover:shadow-lg hover:shadow-amber-600/20"
                    >
                      View Shortlist
                      <ArrowRight className="w-4 h-4" />
                    </button>
            ...
            {pendingTasks.length > 0 && (
              <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-slate-200 dark:border-slate-800">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-slate-900 dark:text-white tracking-tight">Pending Tasks</h3>
                ...
                <div className="space-y-2">
                  {pendingTasks.slice(0, 4).map((task) => (
                    <div
                      key={task.id}
                      className="flex items-center gap-3 p-3 bg-slate-50 dark:bg-slate-950/50 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-900 transition-colors border border-transparent hover:border-slate-200 dark:hover:border-slate-800"
                    >
                      <div className="w-2 h-2 rounded-full bg-orange-500 flex-shrink-0 shadow-[0_0_8px_rgba(249,115,22,0.4)]"></div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl p-5 shadow-sm border border-slate-200 dark:border-slate-800">
              ...
              <div className="space-y-2">
                ...
                >
                  <div className="p-1.5 bg-blue-50 dark:bg-blue-900/20 rounded-lg text-blue-600 dark:text-blue-400 group-hover:scale-105 transition-transform">
                ...
                <Link
                  ...
                  className="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors group"
                >
                  <div className="p-1.5 bg-purple-50 dark:bg-purple-900/20 rounded-lg text-purple-600 dark:text-purple-400 group-hover:scale-105 transition-transform">
                ...
                <Link
                  ...
                  className="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors group"
                >
                  <div className="p-1.5 bg-green-50 dark:bg-green-900/20 rounded-lg text-green-600 dark:text-green-400 group-hover:scale-105 transition-transform">
            ...
            {dashboard?.profile && (
              <div className="bg-white dark:bg-slate-900 rounded-2xl p-5 shadow-sm border border-slate-200 dark:border-slate-800">
                <h3 className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-3">Profile Summary</h3>
